...
const index = () => {
  return (
    <div className='flex flex-col px-8 pt-2'>
      <h1 className='mx-2 my-4 text-2xl font-medium text-justify'>Aspiring Frontend Developer with a solid foundation in web development, proficient in HTML, CSS,
      JavaScript, React and NextJs. Equipped with hands-on experience in creating responsive and user-friendly interfaces.</h1>
      <div className='p-5 my-12 bg-orange-300 rounded-lg' style={{marginLeft:'-1.5rem', marginRight:'-1.5rem'}}>
